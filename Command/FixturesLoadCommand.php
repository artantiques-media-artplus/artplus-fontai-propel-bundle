...
class FixturesLoadCommand extends AbstractCommand
{
    ...
    public function __construct(FileLocatorInterface $fileLocator, ContainerInterface $container)
    {
...
EOT
    ...
    protected function getFixtureFiles($type = 'sql', $in = null)
    {
        ...
        foreach ($files as $file) {
            ...
            $finalFixtureFiles[] = new \SplFileInfo($this->fileLocator->locate($logicalName));
        }
