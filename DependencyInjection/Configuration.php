        ...
        $node
            ->children()
                ->arrayNode('paths')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('projectDir')->defaultValue($this->projectDir)->end()
                        ->scalarNode('schemaDir')->defaultValue($this->projectDir.'/src/propel')->end()
                        ->scalarNode('sqlDir')->defaultValue($this->projectDir.'/src/propel/sql')->end()
                        ->scalarNode('migrationDir')->defaultValue($this->projectDir.'/src/propel/migrations')->end()
